...
To install the React components, you can use npm or yarn:
...
To use the Vue components, follow these steps:

1. Update your generated `vite.config.ts` file as follows:
...
2. Update your `main.ts` file and add Prisma UI Components in the `use()` wrapper:
...
3. Include the custom CSS variables in your `base.css` file:
